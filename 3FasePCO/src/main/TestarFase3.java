...
import domain.Acionavel;
import domain.Aleatorio;
import domain.Ambiente;
import domain.Direcionador;
import domain.EstadoSimulacao;
import domain.Instituicao;
import domain.JogadorConfiante;
import domain.JogadorPrudente;
import domain.Simulador;
import domain.VerticalHorizontal;
import utils.Par;
	...
	private static Direcionador obtemDirecionador(String tipoDesejado) {
		...
		try {
			...
			Constructor construtor = 
					Class.forName("domain." + tipoDesejado).getDeclaredConstructor();
			result = (Direcionador) construtor.newInstance();
//			String t = "domain." + tipoDesejado;
//			@SuppressWarnings("unchecked")
//			Class<Direcionador> klass = (Class<Direcionador>) Class.forName(t);
//			Constructor<Direcionador> cons = klass.getConstructor();
